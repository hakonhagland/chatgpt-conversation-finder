...
class WordIndexManager:
    ...
    def load_index(self) -> None:
        ...
        try:
            ...
            logging.warning(f"Index file not found at {index_path}. Creating a new index.")
            self.update_search_index(self.conversations, self.id_map)
